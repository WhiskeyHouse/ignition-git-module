# Ignition Git Module documentation site
...
Pull requests build the docs and check internal links. Main commits deploy to https://whiskeyhouse.github.io/ignition-git-module/ through GitHub Pages. Set the repository's Pages build source to GitHub Actions before its first deployment.
